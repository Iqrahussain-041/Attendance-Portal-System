...
// Shift timings: 9:00 PM to 9:00 AM
const STANDARD_START_TIME = '21:00:00'; // 9:00 PM
const LATE_THRESHOLD_TIME = '21:20:00'; // 9:20 PM

// Check if time is late (after 9:20 PM)
